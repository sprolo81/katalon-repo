...
5. Run: web-ext sign --artifacts-dir="../web-ext-artifacts" --api-key=$AMO_JWT_ISSUER --api-secret=$AMO_JWT_SECRET 
   Where $AMO_JWT_ISSUER and $AMO_JWT_SECRET are taken from https://addons.mozilla.org/en-US/developers/addon/api/key/ (Create your own account)
